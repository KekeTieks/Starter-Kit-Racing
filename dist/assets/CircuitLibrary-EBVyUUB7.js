...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Xs(e,t,n){let r=new Float32Array(Is),i=new G(0,1,0);return new Pa({name:`SphericalGaussianBlur`,defines:{n:Is,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:$s(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Zs(){return new Pa({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:$s(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Qs(){return new Pa({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:$s(),fragmentShader:`
	...
	`}var ec=class extends qt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new ga([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`+e.vertexShader,e.vertexShader=e.vertexShader.replace(`#include <worldpos_vertex>`,`#include <worldpos_vertex>
		...
		`+e.fragmentShader,e.fragmentShader=e.fragmentShader.replace(`#include <dithering_fragment>`,`#include <dithering_fragment>
			...
			if ( gl_FragColor.a < 0.01 ) discard;`)},t}function Jd(){let e=Ud,t=4.75,n=1.5,r=.25;.5+n*2;let i=.3,a=new Cn,o=new mi(new xa(t*2+r*2,i,e),qd(5592405));o.position.y=3.5+i/2,o.castShadow=!0,o.receiveShadow=!0,a.add(o),n*2;let s=new xa(r*2,3,e),c=qd(6710886);for(let e of[-1,1]){let r=new mi(s,c);r.position.set(e*t,.5+n,0),r.castShadow=!0,r.receiveShadow=!0,a.add(r)}return a}var Yd=new Y,Xd=[[-3,-3,`track-corner`,16],[-2,-3,`track-straight`,22],[-1,-3,`track-straight`,22],[0,-3,`track-corner`,0],[-3,-2,`track-straight`,0],[0,-2,`track-straight`,0],[-3,-1,`track-corner`,10],[-2,-1,`track-corner`,0],[0,-1,`track-straight`,0],[-2,0,`track-straight`,10],[0,0,`track-finish`,0],[-2,1,`track-straight`,10],[0,1,`track-straight`,0],[-2,2,`track-corner`,10],[-1,2,`track-straight`,16],[0,2,`track-corner`,22]],Zd=[[-4,-2,`decoration-tents`,10],[-1,-4,`decoration-tents`,22],[-1,1,`decoration-tents`,22],[-8,-9,`decoration-forest`,0],[-7,-9,`decoration-forest`,0],[-6,-9,`decoration-forest`,0],[-5,-9,`decoration-forest`,0],[-4,-9,`decoration-forest`,0],[-3,-9,`decoration-forest`,0],[-2,-9,`decoration-forest`,0],[-1,-9,`decoration-forest`,0],[0,-9,`decoration-forest`,0],[1,-9,`decoration-forest`,0],[2,-9,`decoration-forest`,0],[-8,-8,`decoration-forest`,0],[-7,-8,`decoration-forest`,0],[-6,-8,`decoration-forest`,0],[-5,-8,`decoration-forest`,0],[-4,-8,`decoration-forest`,0],[-3,-8,`decoration-forest`,0],[-2,-8,`decoration-forest`,0],[-1,-8,`decoration-forest`,0],[0,-8,`decoration-forest`,0],[1,-8,`decoration-forest`,0],[2,-8,`decoration-forest`,0],[-8,-7,`decoration-forest`,0],[-7,-7,`decoration-forest`,0],[-6,-7,`decoration-forest`,0],[-5,-7,`decoration-forest`,0],[-4,-7,`decoration-forest`,0],[-3,-7,`decoration-forest`,0],[-2,-7,`decoration-forest`,0],[-1,-7,`decoration-forest`,0],[0,-7,`decoration-forest`,0],[1,-7,`decoration-forest`,0],[2,-7,`decoration-forest`,0],[-8,-6,`decoration-forest`,0],[-7,-6,`decoration-forest`,0],[-6,-6,`decoration-forest`,0],[-5,-6,`decoration-forest`,0],[-4,-6,`decoration-forest`,0],[-3,-6,`decoration-empty`,0],[-2,-6,`decoration-empty`,0],[-1,-6,`decoration-empty`,0],[0,-6,`decoration-empty`,0],[1,-6,`decoration-forest`,0],[2,-6,`decoration-forest`,0],[-8,-5,`decoration-forest`,0],[-7,-5,`decoration-forest`,0],[-6,-5,`decoration-forest`,0],[-5,-5,`decoration-forest`,0],[-4,-5,`decoration-empty`,0],[-3,-5,`decoration-empty`,0],[-2,-5,`decoration-empty`,0],[-1,-5,`decoration-empty`,0],[0,-5,`decoration-empty`,0],[1,-5,`decoration-forest`,0],[2,-5,`decoration-forest`,0],[-8,-4,`decoration-forest`,0],[-7,-4,`decoration-forest`,0],[-6,-4,`decoration-forest`,0],[-5,-4,`decoration-forest`,0],[-4,-4,`decoration-empty`,0],[1,-4,`decoration-forest`,0],[2,-4,`decoration-forest`,0],[-8,-3,`decoration-forest`,0],[-7,-3,`decoration-forest`,0],[-6,-3,`decoration-forest`,0],[-5,-3,`decoration-forest`,0],[-4,-3,`decoration-empty`,0],[1,-3,`decoration-forest`,0],[2,-3,`decoration-forest`,0],[-8,-2,`decoration-forest`,0],[-7,-2,`decoration-forest`,0],[-6,-2,`decoration-forest`,0],[-5,-2,`decoration-forest`,0],[1,-2,`decoration-forest`,0],[2,-2,`decoration-forest`,0],[-8,-1,`decoration-forest`,0],[-7,-1,`decoration-forest`,0],[-6,-1,`decoration-forest`,0],[-5,-1,`decoration-forest`,0],[-4,-1,`decoration-empty`,0],[-1,-1,`decoration-empty`,0],[1,-1,`decoration-forest`,0],[2,-1,`decoration-forest`,0],[-8,0,`decoration-forest`,0],[-7,0,`decoration-forest`,0],[-6,0,`decoration-forest`,0],[-5,0,`decoration-forest`,0],[-4,0,`decoration-empty`,0],[-3,0,`decoration-empty`,0],[-1,0,`decoration-empty`,0],[1,0,`decoration-forest`,0],[2,0,`decoration-forest`,0],[-8,1,`decoration-forest`,0],[-7,1,`decoration-forest`,0],[-6,1,`decoration-forest`,0],[-5,1,`decoration-forest`,0],[-4,1,`decoration-empty`,0],[-3,1,`decoration-empty`,0],[1,1,`decoration-forest`,0],[2,1,`decoration-forest`,0],[-8,2,`decoration-forest`,0],[-7,2,`decoration-forest`,0],[-6,2,`decoration-forest`,0],[-5,2,`decoration-forest`,0],[-4,2,`decoration-empty`,0],[-3,2,`decoration-empty`,0],[1,2,`decoration-forest`,0],[2,2,`decoration-forest`,0],[-8,3,`decoration-forest`,0],[-7,3,`decoration-forest`,0],[-6,3,`decoration-forest`,0],[-5,3,`decoration-forest`,0],[-4,3,`decoration-forest`,0],[-3,3,`decoration-forest`,0],[-2,3,`decoration-forest`,0],[-1,3,`decoration-forest`,0],[0,3,`decoration-forest`,0],[1,3,`decoration-forest`,0],[2,3,`decoration-forest`,0],[-8,4,`decoration-forest`,0],[-7,4,`decoration-forest`,0],[-6,4,`decoration-forest`,0],[-5,4,`decoration-forest`,0],[-4,4,`decoration-forest`,0],[-3,4,`decoration-forest`,0],[-2,4,`decoration-forest`,0],[-1,4,`decoration-forest`,0],[0,4,`decoration-forest`,0],[1,4,`decoration-forest`,0],[2,4,`decoration-forest`,0]],Qd=[[`vehicle-truck-green`,-3.51,-.01,12.7,98],[`vehicle-truck-purple`,-23.78,-.14,-13.56,0],[`vehicle-truck-red`,-1.36,-.15,-23.8,155.9]];function $d(e,t,n){let r=new Cn;r.position.y=-.5;let i=new Cn,a=new Cn,o=n||Xd,s=[];for(let e of o){let{gx:n,gz:r,type:a,orient:o,isBump:c,bumpOrient:l,isTunnel:u,rampLength:d,rampAngle:f,rampWidth:p}=Bd(e),m=ef(t,a===`track-ramp`?`track-straight`:a,n,r,o);if(m&&i.add(m),a===`track-ramp`){let e=Gd(d,f,p),t=Hd[o]??0;e.position.set((n+.5)*Ud,.5,(r+.5)*Ud),e.rotation.y=Dt.degToRad(t),i.add(e);continue}if(c){let e=ef(t,`track-bump`,n,r,l);e&&i.add(e)}if(u){let e=Jd(),t=Hd[o]??0;e.position.set((n+.5)*Ud,0,(r+.5)*Ud),e.rotation.y=Dt.degToRad(t),e.userData.tunnelGx=n,e.userData.tunnelGz=r,i.add(e),s.push(e)}}if(!n)for(let[e,n,r,i]of Zd){let o=ef(t,r,e,n,i);o&&a.add(o)}{let e=new Set,r=1/0,i=-1/0,s=1/0,c=-1/0;for(let t of o){let{gx:n,gz:a}=Bd(t);e.add(n+`,`+a),r=Math.min(r,n),i=Math.max(i,n),s=Math.min(s,a),c=Math.max(c,a)}if(!n)for(let[t,n]of Zd)e.add(t+`,`+n),r=Math.min(r,t),i=Math.max(i,t),s=Math.min(s,n),c=Math.max(c,n);let l=[],u=[],d=[];function f(e,t){let n=e*374761393+t*668265263;return n=(n^n>>13)*1274126177,(n^n>>16)>>>0}for(let t=s-3;t<=c+3;t++)for(let n=r-3;n<=i+3;n++){if(e.has(n+`,`+t))continue;let a=n<r?r-n:n>i?n-i:0,o=t<s?s-t:t>c?t-c:0,p=Math.max(a,o),m=(n+.5)*Ud,h=(t+.5)*Ud;p<=1?f(n,t)%7==0?d.push(m,h,f(n,t)%4):l.push(m,h):u.push(m,h)}function p(e,t){if(t.length===0||!e)return;let n=t.length/2;e.traverse(e=>{if(!e.isMesh)return;let r=new Bi(e.geometry,e.material,n);r.castShadow=!0,r.receiveShadow=!0;for(let e=0;e<n;e++)Yd.position.set(t[e*2],.5,t[e*2+1]),Yd.updateMatrix(),r.setMatrixAt(e,Yd.matrix);a.add(r)})}p(t[`decoration-empty`],l),p(t[`decoration-forest`],u);let m=t[`decoration-tents`];if(m&&d.length>0){let e=d.length/3;m.traverse(t=>{if(!t.isMesh)return;let n=new Bi(t.geometry,t.material,e);n.castShadow=!0,n.receiveShadow=!0;for(let t=0;t<e;t++)Yd.position.set(d[t*3],.5,d[t*3+1]),Yd.rotation.y=d[t*3+2]*Math.PI/2,Yd.updateMatrix(),n.setMatrixAt(t,Yd.matrix);a.add(n)})}}r.add(i),r.add(a),r.scale.setScalar(.75),e.add(r),r.updateMatrixWorld(!0),r.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!0)});let c=[r];if(!n)for(let[n,r,i,a,o]of Qd){let s=t[n];if(!s)continue;let l=s.clone();l.position.set(r,i,a),l.rotation.y=Dt.degToRad(o+180),l.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!0)}),e.add(l),c.push(l)}return{sceneObjects:c,tunnelCeilings:s}}function ef(e,t,n,r,i){let a=e[t];if(!a)return null;let o=a.clone();o.position.set((n+.5)*Ud,.5,(r+.5)*Ud);let s=Hd[i]??0;return o.rotation.y=Dt.degToRad(s),o}function tf(e){let t=null;for(let n of e){let e=Bd(n);if(e.type===`track-finish`){t=e;break}}if(t||=Bd(e[0]),!t)return{position:[3.5,.5,5],angle:0};let n=(t.gx+.5)*Ud*Wd,r=(t.gz+.5)*Ud*Wd,i=Dt.degToRad(Hd[t.orient]||0);return{position:[n,.5,r],angle:i}}function nf(e){if(!e||e.length===0)return{centerX:0,centerZ:0,halfWidth:30,halfDepth:30};let t=1/0,n=-1/0,r=1/0,i=-1/0;for(let a of e){let{gx:e,gz:o}=Bd(a);t=Math.min(t,e),n=Math.max(n,e),r=Math.min(r,o),i=Math.max(i,o)}let a=Ud*Wd;return{centerX:(t+n+1)/2*a,centerZ:(r+i+1)/2*a,halfWidth:(n-t+1)/2*a+a,halfDepth:(i-r+1)/2*a+a}}var rf=`myrace_profile`,af=new class{constructor(){this._profile=null,this._load()}_load(){try{let e=localStorage.getItem(rf);e&&(this._profile=JSON.parse(e))}catch{}}_save(){this._profile&&localStorage.setItem(rf,JSON.stringify(this._profile))}get profile(){return this._profile}get username(){return this._profile?.username||null}get level(){return this._profile?.level??1}get xp(){return this._profile?.xp??0}get xpThisLevel(){return this._profile?.xp_this_level??0}get xpForNext(){return this._profile?.xp_for_next??141}get credits(){return this._profile?.credits??0}isLoggedIn(){return!!this._profile}async register(e){try{let t=await fetch(`/api/auth/register`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({username:e})}),n=await t.json();return t.ok?this.login(e):{ok:!1,error:n.error||`Erreur serveur`}}catch{return{ok:!1,error:`Serveur inaccessible`}}}async login(e){try{let t=await fetch(`/api/auth/login`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({username:e})}),n=await t.json();return t.ok?(this._profile=n.player,this._save(),{ok:!0}):{ok:!1,error:n.error||`Joueur introuvable`}}catch{return{ok:!1,error:`Serveur inaccessible`}}}async refresh(){if(this.username)try{let e=await fetch(`/api/profile/${encodeURIComponent(this.username)}`),t=await e.json();e.ok&&(this._profile=t.player,this._save())}catch{}}applyRaceResult(e){if(!this._profile)return{leveledUp:!1,oldLevel:1,newLevel:1};let t=this._profile.level;return Object.assign(this._profile,{xp:e.xp,xp_this_level:e.xp_this_level,xp_for_next:e.xp_for_next,credits:e.credits,level:e.new_level}),this._save(),{leveledUp:e.new_level>t,oldLevel:t,newLevel:e.new_level}}applyCredits(e){this._profile&&(this._profile.credits=e,this._save())}logout(){this._profile=null,localStorage.removeItem(rf)}},of={"track-straight":`#8899aa`,"track-corner":`#6688bb`,"track-finish":`#dd4444`,"track-bump":`#cc8833`,"track-ramp":`#dd9944`};async function sf(){let e=af.username,t=e?`/api/circuits?username=`+encodeURIComponent(e):`/api/circuits`,n=await fetch(t);if(!n.ok)throw Error(`Failed to load circuits`);return(await n.json()).circuits}async function cf(e,t){let n=af.username,r=await fetch(`/api/circuits`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({cells:t,name:e,username:n})});if(!r.ok)throw Error(`Failed to save circuit`);return(await r.json()).circuit}async function lf(e,t,n){let r={username:af.username};t&&(r.cells=t),n!==void 0&&(r.name=n);let i=await fetch(`/api/circuits/`+e,{method:`PUT`,headers:{"Content-Type":`application/json`},body:JSON.stringify(r)});if(!i.ok)throw Error(`Failed to update circuit`);return(await i.json()).circuit}async function uf(e){let t=af.username;if(!(await fetch(`/api/circuits/`+e+`?username=`+encodeURIComponent(t),{method:`DELETE`})).ok)throw Error(`Failed to delete circuit`)}function df(e,t=80){if(!e||e.length===0)return`<svg></svg>`;let n=e.map(Bd),r=Math.min(...n.map(e=>e.gx)),i=Math.max(...n.map(e=>e.gx)),a=Math.min(...n.map(e=>e.gz)),o=Math.max(...n.map(e=>e.gz)),s=i-r+1,c=o-a+1,l=Math.floor(Math.min(t/s,t/c)),u=s*l,d=c*l;return`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${u} ${d}" width="${u}" height="${d}">${n.map(e=>`<rect x="${(e.gx-r)*l}" y="${(e.gz-a)*l}" width="${l}" height="${l}" fill="${of[e.type]||`#aaaaaa`}" rx="1"/>`).join(``)}</svg>`}export{_s as $,Sa as A,Dt as B,ns as C,dr as D,xa as E,bs as F,Y as G,mi as H,Cn as I,Ao as J,wa as K,_ as L,Lo as M,mr as N,Er as O,jn as P,Ot as Q,vo as R,rs as S,qn as T,ni as U,J as V,Ia as W,Ta as X,Wi as Y,Po as Z,Bd as _,lf as a,Kr as at,Lu as b,Gd as c,Yo as ct,tf as d,G as dt,Ea as et,nf as f,qt as ft,Hd as g,Wd as h,cf as i,Mo as it,X as j,_a as k,$d as l,ja as lt,Ud as m,df as n,Mn as nt,af as o,Mr as ot,Kd as p,Fo as q,sf as r,Pa as rt,Xd as s,go as st,uf as t,ze as tt,Jd as u,W as ut,Vd as v,Wo as w,Ro as x,Vu as y,Bi as z};